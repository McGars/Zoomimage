...
public class DecorUtils {
    ...
    public static void marginForStatusBar(View view) {
        if (isCanHaveTransparentDecor()) {
            ((ViewGroup.MarginLayoutParams) view.getLayoutParams()).topMargin += getStratusBarHeight(view.getContext());
        }
    }
    ...
    public static void marginForNavBar(View view) {
        if (isCanHaveTransparentDecor()) {
            ((ViewGroup.MarginLayoutParams) view.getLayoutParams()).bottomMargin += getNavBarHeight(view.getContext());
        }
    }
